      ...
      <div>
        <div className="flex items-start justify-between gap-3 mb-3">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-tr from-slate-800 to-slate-700 border border-slate-700/60 flex items-center justify-center font-bold text-lg text-white shrink-0 shadow-inner">
        ...
        <div className="flex flex-wrap items-center gap-2 text-xs mb-3 text-slate-300">
          <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-md bg-slate-800/80 border border-slate-700/60">
            <span>{flag}</span>
          ...
          {/* Experience Level */}
          {job.experienceLevel && (
            <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-md bg-amber-950/30 text-amber-300 border border-amber-800/40 font-medium">
          ...
          {job.salary && (
            <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-md bg-emerald-950/40 text-emerald-300 border border-emerald-800/40 font-semibold">
        ...
        <div className="mb-4">
          ...
          <div className="flex flex-wrap gap-1.5">
            ...
            {job.missingSkills.map((skill) => (
              <span
                key={skill}
                className="inline-flex items-center gap-1 px-2 py-0.5 rounded text-[11px] font-medium bg-slate-800 text-slate-400 border border-slate-700/60"
              >
